...
function ConnectionErrorBodySection() {
  const items = [
    ...
    },
    {
      ...
      paragraphs: [
        "We post updates to our status channels as issues are resolved. You can also reach out to our support team at support@placetrix.app for assistance or questions.",
