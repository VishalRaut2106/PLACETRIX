...
export function DateTimePicker({
  ...
  const initDate = useMemo(() => new TZDate(safeDateValue || new Date(), timezone), [safeDateValue, timezone]);
  ...
  const displayValue: Date | undefined = useMemo(() => {
    if (!open && !safeDateValue) return undefined;
    return open ? date : safeDateValue;
  }, [date, safeDateValue, open]);
